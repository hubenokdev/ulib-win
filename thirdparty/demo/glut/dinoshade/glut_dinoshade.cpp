...
static void makeFloorTexture(void)
{
  ...
  if (useMipmaps) {
    ...
    gluBuild2DMipmaps(GL_TEXTURE_2D, 3, 24, 24,
    ...
    glTexImage2D(GL_TEXTURE_2D, 0, 3, 24, 24, 0,
      GL_RGB, GL_UNSIGNED_BYTE, floorTexture);
  }
}
...
void drawFloor(void)
{
  ...
  glBegin(GL_QUADS);
    ...
    glTexCoord2f(0.0, 24.0);
    glVertex3fv(floorVertices[1]);
    glTexCoord2f(24.0, 24.0);
    glVertex3fv(floorVertices[2]);
    glTexCoord2f(24.0, 0.0);
